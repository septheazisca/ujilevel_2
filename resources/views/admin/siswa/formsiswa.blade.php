      ...
      <div class="col-lg-6">
         <div class="card" style="width: 76vw;">
            <div class="card-body">
               ...
               <form class="row g-3" action="/simpanformsiswa" method="POST">
                           {{  csrf_field() }}
                  <div class="col-md-12"> 
                  ...
                  <div class="col-md-6"> <label for="inputCity" class="form-label">NIS</label> <input type="number"name="nis" class="form-control" id="inputCity"></div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-4"> <label for="inputZip" class="form-label">No. Telpon</label> <input type="number" name="notelepon" class="form-control" id="inputZip"></div>
